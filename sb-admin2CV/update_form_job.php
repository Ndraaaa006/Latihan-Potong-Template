                ...
                <div class="container-fluid">
                    ...
                    <form action="action_insert_job.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="deskripsi" id="deskripsi" cols="30" class="form-control" rows="10" value="<?php echo $job->deskripsi ?>"></textarea>
                        </div>
                        <input type="hidden" value="<?php echo $job->id_job?>"name="id_job">
