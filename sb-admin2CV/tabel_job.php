            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Profession</h1>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <th scope="row"><?php echo $tampil->nama_pekerjaan; ?></th>
                                    ...
                                    <td>
                                        <a href="delete_job.php?id_job=<?php echo $tampil->id_job; ?>" class="btn btn-danger" onclick="return confirm('confirm to delete?')">DELETE</a>
